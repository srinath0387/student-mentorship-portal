...
import { CoordinatorAttendancePage } from '../attendance/coordinator/CoordinatorAttendancePage';
...
export const CoordinatorDashboardPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* ════════════════════════════════════════════════════════════════════════ */}
      {/* TAB: 1ST YEAR ATTENDANCE SYSTEM */}
      {/* ════════════════════════════════════════════════════════════════════════ */}
      {(activeTab === 'attendance' || activeTab === 'manage-attendance') && (
